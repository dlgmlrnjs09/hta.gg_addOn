...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/js/bootstrap.min.js"></script> 
	...
	<div id="header_right">
		...
		<sec:authorize access="isAnonymous()">
			<div id="header_msg">
				<span style="color:rgba(255, 255, 255, 0.5);">
					<i class="far fa-comments" aria-hidden="true" onclick="location.href='/member/login'"></i><br>
				</span>
			</div>
					    	...
					    	<a class="navbar-brand dropdown-toggle" href="#" id="bd-versions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				          	...
				          	<div style="position: absolute; left: -35px;">
					          	<div class="dropdown-menu text-center mt-2" style="left: -10px; position: absolute;">
						            ...
						            <a href="/member/login">Sign-up here</a>
					      		</div>
					      	</div>
					 	</div>
					</div>
		...
		<sec:authorize access="isAuthenticated()">
			<div id="header_msg">
				<span style="color:rgba(255, 255, 255, 0.5);">
					<i class="fa fa-comments" aria-hidden="true" onclick="location.href='/member/member/messageList'"></i><br>
				</span>
			</div>
			<div id="header_mypage">
				<form method="post" action="/member/logout" name="logout">
							        ...
							        <a class="navbar-brand dropdown-toggle" href="#" id="bd-versions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							          ...
							          <div style="position: absolute; left: -35px;">
								          <div class="dropdown-menu text-center mt-2" style="left: -10px; position: absolute;">
								            ...
								            <a href="/member/admin/memberList">
