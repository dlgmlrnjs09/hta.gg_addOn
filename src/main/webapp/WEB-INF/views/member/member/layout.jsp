...
<style type="text/css">
	*{margin:0px;padding:0px;}
	#myPage_Menu{ width:15%;height:100%;float:left;}
	#myPage_section{width:80%; height:654px; float: left;}
	...
	<div id="wrap">
		...
		<div id="content">
			<div style="height: 1500px;">
				...
				<div id="myPage_section" style="margin-left: 21.4%; width: 80%;">
...
// 		} else {
// 			$("#myPage_Menu").css("position", "absolute");
// 			$("#myPage_Menu").css("top", "");
// 		}
// 		console.log(height);
// 	})
