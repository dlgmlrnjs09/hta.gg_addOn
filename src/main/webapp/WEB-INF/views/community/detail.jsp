...
<script type="text/javascript">
			...
			$.ajax({
				...
				success: function(result) {
					...
					if (result == true) {
						...
						window.open('/reportPage?pNum=' + pNum + '&username=' + username,'신고하기','width=500px, height=300px')
					}
				}
			})
		}
	...
	$("#sendMsg").click(function() {
		...
		if (sender == "") {
			...
			window.open('/sendMsgPage?sender=' + sender + '&receiver=' + receiver,'쪽지 보내기','width=500px, height=300px')
		}
	})
