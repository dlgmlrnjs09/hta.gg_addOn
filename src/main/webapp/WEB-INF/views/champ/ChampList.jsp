												...
												$(".winlist tbody")
														.append(
																"<tr><td>"
																		+ (key + 1)
																		+ "</td>"
																		+ "<td><a href='/champ/selectList?championid="+value.CHAMPIONID+"'><image style='width:45px;'  id='"+key+"' src='http://ddragon.leagueoflegends.com/cdn/11.3.1/img/champion/"+value.PICTURE+"'>"
																		+ value.NAME
																		+ "</a></td>"
																		+ "<td>"
																		+ value.WINRANK
							...
							$
									.each(
											...
											function(key, value) {
												...
												$("#charFace")
														.append(
																"<div id='info'><a href='/champ/selectList?championid="
																		+ value.championid
																		+ "'><image id='"+key+"' src='http://ddragon.leagueoflegends.com/cdn/11.3.1/img/champion/"+value.picture+"'>"
																		+	"</a><br>"
																		+ value.name
																		+ "</div>")
