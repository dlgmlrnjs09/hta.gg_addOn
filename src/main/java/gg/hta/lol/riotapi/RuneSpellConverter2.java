...
@Component
public class RuneSpellConverter2 {

    HashMap<Integer, String> spell;
    HashMap<Integer, String> rune;

    public RuneSpellConverter2() {
        spell = new HashMap<Integer, String>();
        rune = new HashMap<Integer, String>();
    ...
    public String convertRune(int id) {
        return rune.get(id);
    }

    public String convertSpell(int id) {
        return spell.get(id);
    }

	/*public int convertRune(int id) {
		if(id==0)
			return 0;
		return Integer.parseInt(rune.get(id));
	}

	public int convertSpell(int id) {
		if(id==0)
			return 0;
		return Integer.parseInt(spell.get(id));
	}*/
